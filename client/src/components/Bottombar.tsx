...
function Bottombar({ todos, rooms, fetchAPI, setSelectedRoom }: BottombarProps) {
    ...
    return (
        <div className="w-full flex flex-row justify-end p-2">
            <div className="flex flex-row gap-6 px-2 lg:pl-8 lg:mr-8">
                <button className="text-white bg-blue-400 rounded-full w-12 h-12 lg:w-14 lg:h-14 flex flex-row items-center justify-center shadow-2xl" onClick={deleteCompletedTodos}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5m6 4.125 2.25 2.25m0 0 2.25 2.25M12 13.875l2.25-2.25M12 13.875l-2.25 2.25M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" />
                    </svg>
                </button>
                <button className="text-white bg-blue-400 rounded-full w-12 h-12 lg:w-14 lg:h-14 flex flex-row items-center justify-center shadow-2xl" onClick={handleOpen}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <Modal open={open} onClose={handleClose} className="flex flex-col justify-center items-center">
                <Box className="absolute top-50 left-50 bg-white rounded-md">
                    <form onSubmit={submitTodo} className="flex flex-col p-4">
                        ...
                        <select
                            className={"p-2 border-2 border-gray-200 rounded-xl my-2 font-body"}
                            name="temp-room"
